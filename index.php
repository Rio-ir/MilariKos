  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php" style="color: white;">Milarikos</a>
      </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="page/konfirmasi_pembelian.php">Konfirmasi Pembelian</a></li>
                <li><a href="">Chat</a></li>
              </ul>
            </li>
