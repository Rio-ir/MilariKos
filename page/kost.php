...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		$sql = "UPDATE kost SET id_pemilik='$_POST[id_pemilik]', nama='$_POST[nama]', alamat='$_POST[alamat]', latitude='$_POST[latitude]', longitude='$_POST[longitude]', tersedia='$_POST[tersedia]', status='$_POST[status]', fasilitas='$_POST[fasilitas]', harga_3bulan='$_POST[harga_3bulan]' WHERE id_kost='$_GET[key]'";
	} else {
		$sql = "INSERT INTO kost VALUES (NULL, '$_POST[id_pemilik]', '$_POST[nama]', '$_POST[alamat]', '$_POST[latitude]', '$_POST[longitude]', '$_POST[tersedia]', '$_POST[status]', '$_POST[fasilitas]', '$_POST[harga_3bulan]', NULL)";
	}
		...
		<div class="col-md-4">
		    <div class="panel panel-<?= ($update) ? "warning" : "info" ?>">
		        ...
		        <div class="panel-body">
    				...
    				<input type="text" id="latitude1" name="latitude" class="form-control" value="<?= $row["latitude"] ?? '' ?>" required>
						</div>
						<div class="form-group">
   							<label for="longitude">Longitude</label>
   	 						<input type="text" id="longitude1" name="longitude" class="form-control" value="<?= $row["longitude"] ?? '' ?>" required>
						</div>
		                <div class="form-group">
		                ...
		                <div class="form-group">
	                    <label for="harga_3bulan">Harga/bln</label>
